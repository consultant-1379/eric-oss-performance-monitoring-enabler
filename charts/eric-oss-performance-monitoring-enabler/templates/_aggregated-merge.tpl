...
*/ -}}
{{- define "eric-oss-performance-monitoring-enabler.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-performance-monitoring-enabler.mergeAnnotations" -}}
  {{- include "eric-oss-performance-monitoring-enabler.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-performance-monitoring-enabler.mergeLabels" -}}
  {{- include "eric-oss-performance-monitoring-enabler.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
