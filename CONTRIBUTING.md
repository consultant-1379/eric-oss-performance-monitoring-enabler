# Contributing to Performance Monitoring Enabler monitors network data on a defined set of network resources for a given time window to determine if there has been a degrade in network performance.
