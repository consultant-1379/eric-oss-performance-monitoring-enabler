...
@Slf4j
@Component
public class SecureVerdictKafkaProducer implements VerdictKafkaProducer {
    private final String verdictTopic;
    private final KafkaTemplate<String, VerdictMessage> kafkaTemplate;

    public SecureVerdictKafkaProducer(@Value("${spring.kafka.topics.verdictTopic}") final String verdictTopic,
                                      @Qualifier("secureVerdictKafkaTemplate") final KafkaTemplate<String, VerdictMessage> kafkaTemplate) {
