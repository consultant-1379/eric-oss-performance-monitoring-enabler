...
class InsecureVerdictKafkaProducerTest {
    private static final String VERDICT_TOPIC = "epme-verdicts";
    @Mock
    private KafkaTemplate<String, VerdictMessage> kafkaTemplate;

    private InsecureVerdictKafkaProducer objectUnderTest;

    @BeforeEach
    void setUp() {
        objectUnderTest = new InsecureVerdictKafkaProducer(VERDICT_TOPIC, kafkaTemplate);
    }
